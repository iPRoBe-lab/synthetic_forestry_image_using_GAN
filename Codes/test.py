...
class Tester():
    ...
    def load_trained_model(self,trained_model):
        if self.args.model == "DCGAN":
            ...
            from DCGAN_1_adjusted_v13 import Generator
    ...
    def generate_synthetic_image_samples(self, trained_model):
        ...
        for step in range(0, num_steps):
            ...
            synthetic_images = self.G(z, self.roi.unsqueeze(0).repeat(current_batch_size,1,1,1), z_values).detach()
...
if __name__ == '__main__':
    ...
    # Model parameters 
    parser.add_argument('--model', type=str, default='DCGAN_1', choices=['DCGAN', 'DCGAN_1'])
    parser.add_argument('--adv_loss', type=str, default='HingeGAN', choices=['HingeGAN'])
    parser.add_argument('--version', type=str, default= 'v13_SN_3_orthogonal_retest_1')
