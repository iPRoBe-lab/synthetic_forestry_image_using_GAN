...
class Generator(nn.Module):
    ...
    def __init__(self, img_height=960, img_width=1296, latent_dim=128, embedding_dim=50, spectral_G = True, batch_norm_G=False, bias_G = True):
        ...
        model += deconv_layer(256, 128, kernel_size=4, stride=2, padding=1, output_padding=(0,1), bias=self.bias, 
                              spectral_norm=self.spectral_norm, batch_norm= self.batch_norm, activation="ReLU",self_attn=True)
...
class Discriminator(nn.Module):
    ...
    def __init__(self, img_height=960, img_width=1296, embedding_dim=50, spectral_D=False, batch_norm_D=True, bias_D=False, sigmoid = False):
        ...
        model += conv_layer(128, 128, kernel_size=4, stride=2, padding=1, bias=self.bias, 
                            spectral_norm=self.spectral_norm, batch_norm= self.batch_norm, activation="LeakyReLU", self_attn=True)
